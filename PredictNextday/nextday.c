...
char mon_str[12][10] = { { "jan" }, { "feb" }, { "mar" }, { "apr" }, { "may" },
...
int main() {
	...
	int i, mo; //i and j are integer counters and mo is input month in int;
	...
	printf("input month value between [1-12] , date [1-31]\n");
